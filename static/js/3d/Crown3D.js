...
class Crown3D {
  ...
  static createBaseCirclet() {
    ...
    for (let i = 0; i < 8; i++) {
      ...
      const gemMaterial = i % 2 === 0 ? Crown3D.getRubyMaterial() : Crown3D.getEmeraldMaterial();
  ...
  static createVelvetCap() {
    ...
    for (let i = 0; i < outerRingCount; i++) {
      ...
      if (i % 2 === 0) {
        ...
        const gemMaterial = i % 4 === 1 ? Crown3D.getSapphireMaterial() : Crown3D.getEmeraldMaterial();
  ...
  static createCrossArches() {
    ...
    for (let i = 0; i < 8; i++) {
      ...
      const starGem = new THREE.Mesh(
        ...
        i % 2 === 0 ? Crown3D.getSapphireMaterial() : Crown3D.getEmeraldMaterial()
      );
