    ...
    <nav className="navbar" style={styles.navbar}>
      <div className="nav-container" style={styles.navContainer}>
        ...
        <div className="nav-menu">
          ...
          <a href="/shop" className="nav-link">유료 상점</a>
          <a href="/showroom" className="nav-link">3D 체험 상점 <span className="beta-badge" style={{backgroundColor: '#FFD700', color: '#000'}}>NEW</span></a>
              ...
              <div className="user-menu" style={{ position: 'relative' }}>
                ...
                >
                  ...
                  >
                    ...
                    <span className="keycap-text" style={styles.keycapText}>유료 상점</span>
                  </a>
                  <a 
                    href="/showroom" 
                    className="user-menu-dropdown-item"
                  ...
                  >
                    <span className="keycap-icon" style={styles.keycapIcon}>📦</span>
                    <span className="keycap-text" style={styles.keycapText}>3D 상점</span>
                  </a>
                  <a 
                    href="/studio" 
                    className="user-menu-dropdown-item"
